...
P.HZ(this,z)},function(a){return this.ZL(a,null)},"yk","$2","$1","gFa",2,2,6,18],
$isb8:1,
...
for(z=new J.m1(b,2,0,null);z.D();)this.h(0,z.c)},
X:function(a){return P.WE(this,"{","}")},
aN:function(a,b){var z
...
rl:{
"^":"r:2;Q",
$1:function(a){return a.FV(0,this.Q)}}}],["","",,F,{
"^":"",
Iq:[function(){var z,y,x,w
z=document.querySelector(".Output")
y=Array(5000)
z.setAttribute("data-class","red")
for(x=0;x<5000;++x){w=document.createElement("div",null)
w.toString
new W.V(w).FV(0,["Box","red"])
y[x]=w
z.appendChild(w)}w=J.X(document.querySelector(".ToggleDart"))
H.J(new W.O(0,w.Q,w.a,W.L(new F.Q(z,y)),w.b),[H.N(w,0)]).Y()},"$0","KW",0,0,1],
Q:{
"^":"r:2;Q,a",
...
y=this.Q
switch(y.getAttribute("data-class")){case"red":y.setAttribute("data-class","green")
for(y=this.a,x=0;x<5000;++x){w=y[x]
w.toString
v=new W.V(w)
v.Rz(0,"red")
v.h(0,"green")}break
case"green":y.setAttribute("data-class","red")
for(y=this.a,x=0;x<5000;++x){w=y[x]
w.toString
v=new W.V(w)
v.Rz(0,"green")
v.h(0,"red")}break}window
y="Dart: "+H.d(window.performance.now()-z)
if(typeof console!="undefined")console.log(y)}}},1],]
...
J.Y9=function(a){return J.R(a).e6(a)}
...
init.metadata=[{func:"NT"},{func:"X0",void:true},{func:"aB",args:[null]},{func:"TS",args:[null,P.I]},{func:"uO",args:[P.I]},{func:"cO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.Gz]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.Gz]},{func:"bh",args:[null,null]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.I,args:[P.KN]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},,];$=null
